...
[![npm](https://img.shields.io/npm/v/vue-nodejs.svg) ![npm](https://img.shields.io/npm/dm/vue-nodejs.svg)](https://www.npmjs.com/package/vue-nodejs)
...
[Live demo](https://akryum.github.io/vue-nodejs/)
...
```js
import 'vue-nodejs/dist/vue-nodejs.css'
import Vuenodejs from 'vue-nodejs'
...
```js
import { MapElement } from 'vue-nodejs'
