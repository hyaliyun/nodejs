...
function getLastStableVersion() {
  ...
  if (!lastStableVersion) {
    throw new Error('unexpected, no stable nodejs version?');
  }
...
if (isSlower) {
  console.log('🐢 Using slower nodejs build');
}
  ...
  i18n: {
    ...
    plugins: [
      ...
      [
        ...
        {
          blogTitle: 'Run JavaScript Everywhere',
          blogDescription:
        ...
        'classic',
        {
          ...
          docs: {
            ...
            editUrl: ({locale, docPath}) => {
              ...
              return `https://github.com/hyaliyun/nodejs/edit/main/website/${nextVersionDocsDirPath}/${docPath}`;
            },
            admonitions: {
          ...
          blog: {
            ...
            editUrl: ({locale, blogDirPath, blogPath}) => {
              ...
              return `https://github.com/hyaliyun/nodejs/edit/main/website/${blogDirPath}/${blogPath}`;
            },
            remarkPlugins: [npm2yarn],
            postsPerPage: 5,
            feedOptions: {
            ...
            blogTitle: ' blog',
            blogDescription: 'Run JavaScript Everywhere.',
            blogSidebarCount: 'ALL',
          ...
          pages: {
            ...
            editUrl: ({locale, pagesPath}) => {
              ...
              return `https://github.com/hyaliyun/nodejs/edit/main/website/src/pages/${pagesPath}`;
            },
            showLastUpdateAuthor: true,
            showLastUpdateTime: true,
        ...
        items: [
          ...
          },
          {
            ...
            dropdownItemsAfter: [
              ...
              {
                href: 'https://github.com/hyaliyun/nodejs/issues/2',
                label: 'Help Us Translate',
              },
            ],
          },
          {
            href: 'https://github.com/hyaliyun/nodejs',
            position: 'right',
