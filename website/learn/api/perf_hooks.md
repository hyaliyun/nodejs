...
[`window.performance.toJSON`]: https://developer.mozilla.org/Web/API/Performance/toJSON
[`window.performance`]: https://developer.mozilla.org/Web/API/Window/performance
