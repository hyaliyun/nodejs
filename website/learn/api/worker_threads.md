...
[HTML structured clone algorithm]: https://developer.mozilla.org/Web/API/Web_Workers_API/Structured_clone_algorithm
[Signals events]: process.md#signal-events
[Web Workers]: https://developer.mozilla.org/Web/API/Web_Workers_API
...
[`EventTarget`]: https://developer.mozilla.org/Web/API/EventTarget
...
[`WebAssembly.Module`]: https://developer.mozilla.org/Web/JavaScript/Reference/Global_Objects/WebAssembly/Module
[`Worker constructor options`]: #new-workerfilename-options
[`Worker`]: #class-worker
[`data:` URL]: https://developer.mozilla.org/Web/HTTP/Basics_of_HTTP/Data_URIs
...
[`port.onmessage()`]: https://developer.mozilla.org/Web/API/MessagePort/onmessage
...
[browser `MessagePort`]: https://developer.mozilla.org/Web/API/MessagePort
