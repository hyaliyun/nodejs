...
One common way to block the Event Loop disastrously is by using a "vulnerable" [regular expression](https://developer.mozilla.org/Web/JavaScript/Guide/Regular_Expressions).
