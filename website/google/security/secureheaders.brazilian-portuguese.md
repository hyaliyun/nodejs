...
🔗 [Leia na documentação web da MDN](https://developer.mozilla.org/Web/HTTP/Headers/Strict-Transport-Security)
...
🔗 [Leia na documentação web da MDN](https://developer.mozilla.org/Web/HTTP/Public_Key_Pinning)
...
🔗 [Leia na documentação web da MDN](https://developer.mozilla.org/Web/HTTP/Headers/X-Frame-Options)
...
🔗 [Leia na documentação web da MDN](https://developer.mozilla.org/Web/HTTP/Headers/X-XSS-Protection)
...
🔗 [Leia na documentação web da MDN](https://developer.mozilla.org/Web/HTTP/Headers/X-Content-Type-Options)
...
🔗 [Leia na documentação web da MDN](https://developer.mozilla.org/Web/HTTP/Headers/Referrer-Policy)
...
🔗 [Leia na documentação web da MDN](https://developer.mozilla.org/Web/HTTP/Headers/Content-Security-Policy)
