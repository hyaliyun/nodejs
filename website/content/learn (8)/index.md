...
JavaScript is arguably more difficult to learn than related technologies such as [HTML](/content/Learn/HTML) and [CSS](/content/Learn/CSS). Before attempting to learn JavaScript, you are strongly advised to get familiar with at least these two technologies first, and perhaps others as well. Start by working through the following modules:

- [Getting started with the Web](/content/Learn/Getting_started_with_the_web)
- [Introduction to HTML](/content/Learn/HTML/Introduction_to_HTML)
- [Introduction to CSS](/content/Learn/CSS/First_steps)
...
- JavaScript in depth, as taught in our [JavaScript guide](/content/Web/JavaScript/Guide)
- [Web APIs](/content/Web/API)
...
- [JavaScript building blocks](/content/Learn/JavaScript/Building_blocks)
...
- [Introducing JavaScript objects](/content/Learn/JavaScript/Objects)
...
- [Client-side web APIs](/content/Learn/JavaScript/Client-side_web_APIs)
...
[Solve common problems in your JavaScript code](/content/Learn/JavaScript/Howto) provides a little advice on how to avoid common beginner JavaScript programming mistakes, along with many helpful links to topics that show how to solve common JavaScript programming problems.

## See also

- [JavaScript on MDN](/content/Web/JavaScript)
