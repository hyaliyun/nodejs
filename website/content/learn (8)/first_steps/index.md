...
- [Getting started with the Web](/content/Learn/Getting_started_with_the_web) (which includes a really [basic JavaScript introduction](/content/Learn/Getting_started_with_the_web/JavaScript_basics)).
...
- [What is JavaScript?](/content/Learn/JavaScript/First_steps/What_is_JavaScript)
...
- [A first splash into JavaScript](/content/Learn/JavaScript/First_steps/A_first_splash)
...
- [What went wrong? Troubleshooting JavaScript](/content/Learn/JavaScript/First_steps/What_went_wrong)
...
- [Storing the information you need — Variables](/content/Learn/JavaScript/First_steps/Variables)
  - : After reading the last couple of articles you should now know what JavaScript is, what it can do for you, how you use it alongside other web technologies, and what its main features look like from a high level. In this article, we will get down to the real basics, looking at how to work with the most basic building blocks of JavaScript — Variables.
- [Basic math in JavaScript — numbers and operators](/content/Learn/JavaScript/First_steps/Math)
...
- [Handling text — strings in JavaScript](/content/Learn/JavaScript/First_steps/Strings)
...
- [Useful string methods](/content/Learn/JavaScript/First_steps/Useful_string_methods)
...
- [Arrays](/content/Learn/JavaScript/First_steps/Arrays)
...
- [Silly story generator](/content/Learn/JavaScript/First_steps/Silly_story_generator)
