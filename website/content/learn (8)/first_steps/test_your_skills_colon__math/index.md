...
The aim of the tests on this page is to assess whether you've understood the [Basic math in JavaScript — numbers and operators](/content/Learn/JavaScript/First_steps/Math) article.
...
5. Check if `finalResult` is an even number using one of the [arithmetic operators](/content/Learn/JavaScript/First_steps/Math#arithmetic_operators). Store the result (`0` for even, `1` for odd) in a variable called `evenOddResult`.
