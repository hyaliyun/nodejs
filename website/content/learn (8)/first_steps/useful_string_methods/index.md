...
Let's enter some examples into the [browser developer console](/content/Learn/Common_questions/Tools_and_setup/What_are_browser_developer_tools).
...
You've reached the end of this article, but can you remember the most important information? You can find some further tests to verify that you've retained this information before you move on — see [Test your skills: Strings](/content/Learn/JavaScript/First_steps/Test_your_skills:_Strings).
