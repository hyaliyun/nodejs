...
The [`Event`](/content/Web/API/Event) object has a function available on it called [`stopPropagation()`](/content/Web/API/Event/stopPropagation) which, when called inside an event handler, prevents the event from bubbling up to any other elements.
...
You've reached the end of this article, but can you remember the most important information? To verify you've retained this information before you move on — see [Test your skills: Events](/content/Learn/JavaScript/Building_blocks/Test_your_skills:_Events).
...
- [Event reference](/content/Web/Events)
