    ...
    <tr>
      ...
      <td>
        <p>
          ...
          >,
          <a href="/content/Learn/JavaScript/Building_blocks/Functions"
...
Let's return to a familiar example (from a [previous article](/content/Learn/JavaScript/Building_blocks/Functions#built-in_browser_functions) in this series):
...
The [`replace()`](/content/Web/JavaScript/Reference/Global_Objects/String/replace) function is invoked on the `myText` string, and is passed two parameters:
...
If you look at the [`replace()`](/content/Web/JavaScript/Reference/Global_Objects/String/replace) function MDN reference page, you'll see a section called [return value](/content/Web/JavaScript/Reference/Global_Objects/String/replace#return_value). It is very useful to know and understand what values are returned by functions, so we try to include this information wherever possible.

Some functions don't return any value. (In these cases, our reference pages list the return value as [`void`](/content/Web/JavaScript/Reference/Operators/void) or [`undefined`](/content/Web/JavaScript/Reference/Global_Objects/undefined).) For example, in the [`displayMessage()`](https://github.com/mdn/learning-area/blob/main/javascript/building-blocks/functions/function-stage-4.html#L50) function we built in the previous article, no specific value is returned when the function is invoked. It just makes a box appear somewhere on the screen — that's it!
...
To return a value from a custom function, you need to use the [return](/content/Web/JavaScript/Reference/Statements/return) keyword. We saw this in action recently in our [random-canvas-circles.html](https://github.com/mdn/learning-area/blob/main/javascript/building-blocks/loops/random-canvas-circles.html) example. Our `draw()` function draws 100 random circles somewhere on an HTML {{htmlelement("canvas")}}:
...
You've reached the end of this article, but can you remember the most important information? You can find some further tests to verify that you've retained this information before you move on — see [Test your skills: Functions](/content/Learn/JavaScript/Building_blocks/Test_your_skills:_Functions).
...
- [Functions in-depth](/content/Web/JavaScript/Reference/Functions) — a detailed guide covering more advanced functions-related information.
