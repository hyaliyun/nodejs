...
> [!NOTE]
> To run this site, you'll have to run a local web server, because file:// URLs are not allowed to load workers. See our guide to [setting up a local testing server](/content/Learn/Common_questions/Tools_and_setup/set_up_a_local_testing_server). With that done, you should be able to click "Generate primes" and have your main page stay responsive.
>
...
- [_Shared workers_](/content/Web/API/SharedWorker) can be shared by several different scripts running in different windows.
- [_Service workers_](/content/Web/API/Service_Worker_API) act like proxy servers, caching resources so that web applications can work when the user is offline. They're a key component of [Progressive Web Apps](/content/Web/Progressive_web_apps).
...
- [Using web workers](/content/Web/API/Web_Workers_API/Using_web_workers)
- [Using service workers](/content/Web/API/Service_Worker_API/Using_Service_Workers)
- [Web workers API](/content/Web/API/Web_Workers_API)
