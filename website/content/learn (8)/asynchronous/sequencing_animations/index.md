...
In this assessment you'll update a page to play a series of animations in a sequence. To do this you'll use some of the techniques we learned in the [How to use Promises](/content/Learn/JavaScript/Asynchronous/Promises) article.
...
The images are taken from our guide to [Using the Web Animations API](/content/Web/API/Web_Animations_API/Using_the_Web_Animations_API).
...
We're using the [Web Animations API](/content/Web/API/Web_Animations_API) to animate the images, specifically the {{domxref("Element/animate", "element.animate()")}} method.
...
1. First, implement something that works, but has the promise version of the "callback hell" problem we saw in our [discussion of using callbacks](/content/Learn/JavaScript/Asynchronous/Introducing#callbacks).

2. Next, implement it as a [promise chain](/content/Learn/JavaScript/Asynchronous/Promises#chaining_promises). Note that there are a few different ways you can write this, because of the different forms you can use for an [arrow function](/content/Learn/JavaScript/Building_blocks/Functions#arrow_functions). Try some different forms. Which is the most concise? Which do you find the most readable?

3. Finally, implement it using [`async` and `await`](/content/Learn/JavaScript/Asynchronous/Promises#async_and_await).
