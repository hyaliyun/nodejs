    ...
    <tr>
      ...
      <td>
        ...
        handles and responds to HTTP requests (see <a
          href="/content/Learn/Server-side/First_steps/Client-Server_overview"
...
[Deno](https://deno.com/) is a simple, modern, and secure [JavaScript](/content/Web/JavaScript)/TypeScript runtime and framework built on top of Chrome V8 and [Rust](https://www.rust-lang.org/).

Deno is powered by [Tokio](https://tokio.rs/) — a Rust-based asynchronous runtime which lets it serve web pages faster. It also has internal support for [WebAssembly](/content/WebAssembly), which enables the compilation of binary code for use on the client-side. Deno aims to fill in some of the loop-holes in [Node.js](/content/Learn/Server-side/Node_server_without_framework) by providing a mechanism that naturally maintains better security.
