...
Before starting this module you don't need to have any knowledge of Django. Ideally, you would need to understand what server-side web programming and web frameworks are by reading the topics in our [Server-side website programming first steps](/content/Learn/Server-side/First_steps) module.

A general knowledge of programming concepts and [Python](/content/Glossary/Python) is recommended, but is not essential to understanding the core concepts.
...
- [Django introduction](/content/Learn/Server-side/Django/Introduction)
...
- [Setting up a Django development environment](/content/Learn/Server-side/Django/development_environment)
...
- [Django Tutorial: The Local Library website](/content/Learn/Server-side/Django/Tutorial_local_library_website)
...
- [Django Tutorial Part 2: Creating a skeleton website](/content/Learn/Server-side/Django/skeleton_website)
...
- [Django Tutorial Part 3: Using models](/content/Learn/Server-side/Django/Models)
...
- [Django Tutorial Part 4: Django admin site](/content/Learn/Server-side/Django/Admin_site)
...
- [Django Tutorial Part 5: Creating our home page](/content/Learn/Server-side/Django/Home_page)
...
- [Django Tutorial Part 6: Generic list and detail views](/content/Learn/Server-side/Django/Generic_views)
...
- [Django Tutorial Part 7: Sessions framework](/content/Learn/Server-side/Django/Sessions)
...
- [Django Tutorial Part 8: User authentication and permissions](/content/Learn/Server-side/Django/Authentication)
...
- [Django Tutorial Part 9: Working with forms](/content/Learn/Server-side/Django/Forms)
  - : In this tutorial we'll show you how to work with [HTML Forms](/content/Learn/Forms) in Django, and in particular the easiest way to write forms to create, update and delete model instances. As part of this demonstration, we'll extend the _LocalLibrary_ website so that librarians can renew books, and create, update, and delete authors using our own forms (rather than using the admin application).
- [Django Tutorial Part 10: Testing a Django web application](/content/Learn/Server-side/Django/Testing)
...
- [Django Tutorial Part 11: Deploying Django to production](/content/Learn/Server-side/Django/Deployment)
...
- [Django web application security](/content/Learn/Server-side/Django/web_application_security)
  - : Protecting user data is an essential part of any website design. We previously explained some of the more common security threats in the article [Web security](/content/Web/Security) — this article provides a practical demonstration of how Django's built-in protections handle such threats.
...
- [DIY Django mini blog](/content/Learn/Server-side/Django/django_assessment_blog)
