...
Then we create and configure a repository named "django_local_library" for storing the [Local library website](/content/Learn/Server-side/Django/Tutorial_local_library_website) as we evolve it in the rest of this tutorial.
