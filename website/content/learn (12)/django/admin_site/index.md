...
<table>
  <tbody>
    <tr>
      ...
      <td>
        First complete: <a href="/content/Learn/Server-side/Django/Models"
...
> [!NOTE]
> The lines above assume that you accepted the challenge to create a model to represent the natural language of a book ([see the models tutorial article](/content/Learn/Server-side/Django/Models))!
...
> We'll define a URL mapping and associated view in [Django Tutorial Part 6: Generic list and detail views](/content/Learn/Server-side/Django/Generic_views).
