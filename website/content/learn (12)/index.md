...
Most major websites use some kind of server-side technology to dynamically display data as required. For example, imagine how many products are available on Amazon, and imagine how many posts have been written on Facebook. Displaying all of these using different static pages would be extremely inefficient, so instead such sites display static templates (built using [HTML](/content/Learn/HTML), [CSS](/content/Learn/CSS), and [JavaScript](/content/Learn/JavaScript)), and then dynamically update the data displayed inside those templates when needed, such as when you want to view a different product on Amazon.
...
- [Django Web Framework (Python)](/content/Learn/Server-side/Django)
...
- [Express Web Framework (Node.js/JavaScript)](/content/Learn/Server-side/Express_Nodejs)
...
- [Node server without framework](/content/Learn/Server-side/Node_server_without_framework)
...
- [Properly configuring server MIME types](/content/Learn/Server-side/Configuring_server_MIME_types)
...
- [Apache Configuration: .htaccess](/content/Learn/Server-side/Apache_Configuration_htaccess)
