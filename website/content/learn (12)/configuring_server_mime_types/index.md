...
> [!NOTE]
> See [MIME types (IANA media types)](/content/Web/HTTP/Basics_of_HTTP/MIME_types) for more information.
...
- In Firefox
  ...
  - You can also go to **Tools > Web Developer > Network** and reload the page. The request tab gives you a list of all the resources the page loaded. Clicking on any resource will list all the information available, including the page's [`Content-Type`](/content/Web/HTTP/Headers/Content-Type) header.
...
- If you're using the Apache web server, check the **_Media Types and Character Encodings_** section of [Apache Configuration: .htaccess](/content/Learn/Server-side/Apache_Configuration_htaccess) for examples of different document types and their corresponding MIME types.
...
- [MIME types (IANA media types)](/content/Web/HTTP/Basics_of_HTTP/MIME_types)
