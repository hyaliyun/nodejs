...
> [!NOTE]
> The appearance of the author _lifespan_ dates is ugly! You can improve this using the [same approach](/content/Learn/Server-side/Express_Nodejs/Displaying_data/Date_formatting_using_moment) as we used for the `BookInstance` list (adding the virtual property for the lifespan to the `Author` model).
>
...
Proceed to the next subarticle of part 5: [Genre detail page](/content/Learn/Server-side/Express_Nodejs/Displaying_data/Genre_detail_page).
