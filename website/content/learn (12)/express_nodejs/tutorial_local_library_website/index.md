...
<table>
  <tbody>
    <tr>
      ...
      <td>
        Read the <a href="/content/Learn/Server-side/Express_Nodejs/Introduction">Express Introduction</a>.
        For the following articles you'll also need to have <a href="/content/Learn/Server-side/Express_Nodejs/development_environment">set up a Node development environment</a>.
      </td>
    </tr>
    <tr>
...
Now that you know a bit more about the _LocalLibrary_ website and what you're going to learn, it's time to start creating a [skeleton project](/content/Learn/Server-side/Express_Nodejs/skeleton_website) to contain our example.
