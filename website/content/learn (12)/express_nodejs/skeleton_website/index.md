...
This second article in our [Express Tutorial](/content/Learn/Server-side/Express_Nodejs/Tutorial_local_library_website) shows how you can create a "skeleton" website project which you can then go on to populate with site-specific routes, templates/views, and database calls.
...
<table>
  <tbody>
    <tr>
      ...
      <td>
        <a href="/content/Learn/Server-side/Express_Nodejs/development_environment">Set up a Node development environment</a>.
...
>   We have changed most of these to [`const`](/content/Web/JavaScript/Reference/Statements/const) (and a few to [`let`](/content/Web/JavaScript/Reference/Statements/let)) in the tutorial, because we want to demonstrate modern JavaScript practice.
...
You should already have installed the generator as part of [setting up a Node development environment](/content/Learn/Server-side/Express_Nodejs/development_environment). As a quick reminder, you install the generator tool site-wide using the npm package manager, as shown:
