...
**[Perceived performance](/content/Glossary/Perceived_performance)** is a subjective measure of website performance, responsiveness, and reliability. In other words, how fast a website seems to the user. It is harder to quantify and measure than the actual speed of operation, but perhaps even more important.
...
- [First paint](/content/Glossary/First_paint)
...
- [First Contentful Paint](/content/Glossary/First_contentful_paint) (FCP)
...
- [First Meaningful Paint](/content/Glossary/First_meaningful_paint) (FMP)
...
- [Speed index](/content/Glossary/Speed_index)
...
- [Time to interactive](/content/Glossary/Time_to_interactive)
  - : Time until the UI is available for user interaction (i.e. the last [long task](/content/Glossary/Long_task) of the load process finishes).
