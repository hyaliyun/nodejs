  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <a href="/content/Learn/Common_questions/Web_mechanics/How_does_the_Internet_work"
...
- **They feature asynchronous requests**. Some browsers (including Chrome) will not run async requests (see [Fetching data from the server](/content/Learn/JavaScript/Client-side_web_APIs/Fetching_data)) if you just run the example from a local file. This is because of security restrictions (for more on web security, read [Website security](/content/Learn/Server-side/First_steps/Website_security)).
...
- Python web frameworks, such as [Django](/content/Learn/Server-side/Django), [Flask](https://flask.palletsprojects.com/), and [Pyramid](https://trypyramid.com/).
- Node/JavaScript frameworks such as [Express Web Framework (Node.js/JavaScript)](/content/Learn/Server-side/Express_Nodejs)
