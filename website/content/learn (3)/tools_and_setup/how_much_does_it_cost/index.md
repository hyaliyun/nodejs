  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <a href="/content/Learn/Common_questions/Tools_and_setup/What_software_do_I_need"
        ...
        >, and what
        <a href="/content/Learn/Common_questions/Web_mechanics/What_is_a_domain_name"
          >a domain name is</a
        >.
      </td>
    </tr>
...
You also need a way to upload files: from your hard drive to a distant web server. To do that you should use a publishing tool such as an (S)[FTP client](/content/Glossary/FTP), [RSync](https://en.wikipedia.org/wiki/Rsync), or [Git/GitHub](https://docs.github.com/en/pages/configuring-a-custom-domain-for-your-github-pages-site).
...
Now that you understand what kind of money your website may cost you, it's time to start designing that website and [setting up your work environment](/content/Learn/Common_questions/Tools_and_setup/set_up_a_local_testing_server).

- Read on about [how to choose and install a text editor](/content/Learn/Common_questions/Tools_and_setup/Available_text_editors).
- If you're more focused on design, take a look at the [anatomy of a web page](/content/Learn/Common_questions/Design_and_accessibility/Common_web_layouts).
