...
<table>
  <tbody>
    <tr>
      ...
      <td>
        You must know
        <a href="/content/Learn/Common_questions/Web_mechanics/What_is_a_web_server"
        ...
        <a
          href="/content/Learn/Common_questions/Tools_and_setup/set_up_a_local_testing_server"
...
If you have built a simple web page (see [HTML basics](/content/Learn/Getting_started_with_the_web/HTML_basics) for an example), you will probably want to put it online, on a web server. In this article we'll discuss how to do that, using various available options such as SFTP clients, RSync and GitHub.
...
> [!NOTE]
> Of course there are lots of other options. See [Publishing tools](/content/Learn/Common_questions/Tools_and_setup/How_much_does_it_cost#publishing_tools) for more information.
...
We've covered the basics of using this in the [Publishing your website](/content/Learn/Getting_started_with_the_web/Publishing_your_website) article from our [Getting started with the Web](/content/Learn/Getting_started_with_the_web) guide, so we aren't going to repeat it all here.
