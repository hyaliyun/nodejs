  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <a href="/content/Learn/Common_questions/Design_and_accessibility/What_is_accessibility"
...
The  defines a good color mix with an algorithm that calculates luminosity ratio between foreground and background. The calculation may seem pretty complicated, but we can rely on tools to do the job for us.
