...
[Start learning Ember](/content/Learn/Tools_and_testing/Client-side_JavaScript_frameworks/Ember_getting_started)
...
[Start learning Angular](/content/Learn/Tools_and_testing/Client-side_JavaScript_frameworks/Angular_getting_started)
...
[Start learning Vue](/content/Learn/Tools_and_testing/Client-side_JavaScript_frameworks/Vue_getting_started)
...
[Start learning React](/content/Learn/Tools_and_testing/Client-side_JavaScript_frameworks/React_getting_started)
...
How do we show one of those tasks to our users? We want to represent each task as a list item – an HTML [`<li>`](/content/Web/HTML/Element/li) element inside of an unordered list element (a [`<ul>`](/content/Web/HTML/Element/ul)). How do we make it? That could look something like this:
...
Here, we use the [`document.createElement()`](/content/Web/API/Document/createElement) method to make our `<li>`, and several more lines of code to create the properties and child elements it needs.
...
- [`Array.forEach()`](/content/Web/JavaScript/Reference/Global_Objects/Array/forEach)
- [`Document.createDocumentFragment()`](/content/Web/API/Document/createDocumentFragment)
- [`Document.createElement()`](/content/Web/API/Document/createElement)
- [`Element.setAttribute()`](/content/Web/API/Element/setAttribute)
- [`Node.appendChild()`](/content/Web/API/Node/appendChild)
- [`Node.removeChild()`](/content/Web/API/Node/removeChild)
- [`Node.textContent`](/content/Web/API/Node/textContent)
...
> [!NOTE]
> If you want to find out more details about web tooling concepts, check out our [Client-side tooling overview](/content/Learn/Tools_and_testing/Understanding_client-side_tools/Overview).
