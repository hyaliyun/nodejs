...
2. We have to decide what events our `Todo` component will emit:
   ...
   Here we are using the [spread syntax](/content/Web/JavaScript/Reference/Operators/Spread_syntax) to return the original to-do with the modifications applied to it.
