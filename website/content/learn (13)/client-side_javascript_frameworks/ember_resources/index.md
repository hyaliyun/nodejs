...
alternative is to any fully-featured front-end data client is [The Fetch API](/content/Web/API/Fetch_API/Using_Fetch).
...
experience with [React](/content/Learn/Tools_and_testing/Client-side_JavaScript_frameworks/React_getting_started). While it is technically possible to use JSX, or any
