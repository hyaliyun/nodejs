...
> [!NOTE]
> If you don't have the above installed, find out [more about installing npm and Node.js](/content/Learn/Tools_and_testing/Understanding_client-side_tools/Command_line#adding_powerups) here.
...
Let's make our first change to the app — we'll delete the Vue logo. Open the `App.vue` file, and delete the [`<img>`](/content/Web/HTML/Element/img) element from the template section:
