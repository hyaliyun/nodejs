...
Now open `index.html` and change the [`<title>`](/content/Web/HTML/Element/title) element's text to `TodoMatic`. This way, it will match the [`<h1>`](/content/Web/HTML/Element/Heading_Elements) at the top of our app.
...
- We have a [`<form>`](/content/Web/HTML/Element/form) element, with an [`<input type="text">`](/content/Web/HTML/Element/input/text) for writing out a new task, and a button to submit the form.
- We have an array of buttons that will be used to filter our tasks.
- We have a heading that tells us how many tasks remain.
- We have our 3 tasks, arranged in an unordered list. Each task is a list item ([`<li>`](/content/Web/HTML/Element/li)), and has buttons to edit and delete it and a checkbox to check it off as done.
...
Further down, you can find our [`<ul>`](/content/Web/HTML/Element/ul) element:
