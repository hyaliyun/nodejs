  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        of the high-level
        <a href="/content/Learn/Tools_and_testing/Cross_browser_testing/Introduction">principles of cross browser testing</a>, and
        <a href="/content/Learn/Tools_and_testing/Cross_browser_testing/Automated_testing">automated testing</a>.
      </td>
    </tr>
    <tr>
...
1. To start with, set up a new npm project, as discussed in [Setting up Node and npm](/content/Learn/Tools_and_testing/Cross_browser_testing/Automated_testing#setting_up_node_and_npm) in the last chapter. Call it something different, like `selenium-test`.
