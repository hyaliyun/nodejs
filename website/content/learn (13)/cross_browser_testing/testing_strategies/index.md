...
You should include accessibility as a grade A testing requirement (we'll cover exactly what you should test in our [Handling common accessibility problems](/content/Learn/Tools_and_testing/Cross_browser_testing/Accessibility) article).
...
- They can also provide a basis for writing automated tests. It is easier to write such tests if you know exactly what you want to test, and what the success conditions are (see [Selenium](/content/Learn/Tools_and_testing/Cross_browser_testing/Your_own_automation_environment#selenium), later in the series).
