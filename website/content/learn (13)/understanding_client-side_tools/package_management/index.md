...
- Writing the code to include the package(s) in your application (this tends to be done using [JavaScript modules](/content/Web/JavaScript/Guide/Modules), another subject that is worth reading up on and understanding).
...
- `"type": "module"`, which causes Node to interpret all `.js` files as [ES modules](/content/Web/JavaScript/Guide/Modules) rather than the old CommonJS modules. It's a generally good habit to get into.
