...
This section will get you over the line to storing your code in a git repository, but it is a far cry from a git tutorial. There are many great tutorials and books available, and our [Git and GitHub](/content/Learn/Tools_and_testing/GitHub) page is a good place to start.
...
- [And many more types](https://en.wikipedia.org/wiki/Functional_testing). Also, see our [cross browser testing module](/content/Learn/Tools_and_testing/Cross_browser_testing) for a bunch of useful testing information.
