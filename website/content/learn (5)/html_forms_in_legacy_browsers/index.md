...
All HTML input types are useable in all browsers, even ancient ones, because the way they degrade is highly predictable. If a browser does not know the value of the [`type`](/content/Web/HTML/Element/input#type) attribute of an  element, it will fall back as if the value were `text`.
...
- The  element with its attribute [`type`](/content/Web/HTML/Element/input#type) set to the values `button`, `submit`, `reset` or `image`
- The {{HTMLElement("button")}} element

##### 

The  element can make things a little difficult if you want to apply some CSS by using the element selector:
...
If you read all the articles of this [HTML Forms guide](/content/Learn/Forms), you should now be at ease with using forms. If you discover new techniques or hints, please help improve the guide.
...
- [The native form widgets](/content/Learn/Forms/Basic_native_form_controls)
...
- [How to build custom form widgets](/content/Learn/Forms/How_to_build_custom_form_controls)
