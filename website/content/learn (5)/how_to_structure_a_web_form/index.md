...
<table>
  <tbody>
    <tr>
      ...
      <td>
        A basic <a href="/content/Learn/HTML/Introduction_to_HTML">understanding of HTML</a>.
      </td>
    </tr>
    <tr>
...
The flexibility of forms makes them one of the most complex structures in [HTML](/content/Learn/HTML); you can build any kind of basic form using dedicated form elements and attributes. Using the correct structure when building an HTML form will help ensure that the form is both usable and [accessible](/content/Learn/Accessibility).
...
It's always possible to use a form control outside of a {{HTMLElement("form")}} element. If you do so, by default that control has nothing to do with any form unless you associate it with a form using its [`form`](/content/Web/HTML/Element/input#form) attribute. This was introduced to let you explicitly bind a control with a form even if it is not nested inside it.
...
Let's put these ideas into practice and build a slightly more involved form — a payment form. This form will contain a number of control types that you may not yet understand. Don't worry about this for now; you'll find out how they work in the next article ([Basic native form controls](/content/Learn/Forms/Basic_native_form_controls)). For now, read the descriptions carefully as you follow the below instructions, and start to form an appreciation of which wrapper elements we are using to structure the form, and why.
...
5. The second `<section>` of our form is the payment information.
   ...
   These newer input types are reintroduced in [The HTML5 input types](/content/Learn/Forms/HTML5_input_types).
...
We applied some extra CSS to the finished form below. If you'd like to make changes to the appearance of your form, you can copy styles from [the example](/content/Learn/Forms/How_to_structure_a_web_form/Example) or visit [Styling web forms](/content/Learn/Forms/Styling_web_forms).

{{EmbedLiveSample("active_learning_building_a_form_structure","100%",620)}}

## Test your skills!

You've reached the end of this article, but can you remember the most important information? You can find a further test to verify that you've retained this information before you move on — see [Test your skills: Form structure](/content/Learn/Forms/Test_your_skills:_Form_structure).
