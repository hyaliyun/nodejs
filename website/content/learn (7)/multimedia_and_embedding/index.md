...
Before starting this module, you should have a reasonable understanding of the basics of HTML, as previously covered in [Introduction to HTML](/content/Learn/HTML/Introduction_to_HTML). If you have not worked through this module (or something similar), work through it first, then come back!
...
- [Images in HTML](/content/Learn/HTML/Multimedia_and_embedding/Images_in_HTML)
...
- [Video and audio content](/content/Learn/HTML/Multimedia_and_embedding/Video_and_audio_content)
...
- [From \<object> to \<iframe> — other embedding technologies](/content/Learn/HTML/Multimedia_and_embedding/Other_embedding_technologies)
...
- [Adding vector graphics to the Web](/content/Learn/HTML/Multimedia_and_embedding/Adding_vector_graphics_to_the_Web)
...
- [Mozilla splash page](/content/Learn/HTML/Multimedia_and_embedding/Mozilla_splash_page)
...
- [Add a hitmap on top of an image](/content/Learn/HTML/Howto/Add_a_hit_map_on_top_of_an_image)
