...
HTML is designed with extensibility in mind for data that should be associated with a particular element but need not have any defined meaning. [`data-*` attributes](/content/Web/HTML/Global_attributes/data-*) allow us to store extra information on standard, semantic HTML elements without other hacks such as non-standard attributes, or extra properties on DOM.
...
Note that, as data attributes are plain HTML attributes, you can even access them from [CSS](/content/Web/CSS). For example to show the parent data on the article you can use [generated content](/content/Web/CSS/content) in CSS with the [`attr()`](/content/Web/CSS/attr) function:
...
You can also use the [attribute selectors](/content/Web/CSS/Attribute_selectors) in CSS to change styles according to the data:
