...
The aim of this skill test is to assess whether you understand how to [mark up text in HTML](/content/Learn/HTML/Introduction_to_HTML/HTML_text_fundamentals) to give it structure and meaning.
