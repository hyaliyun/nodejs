...
The aim of this skill test is to assess whether you understand how to use [lesser-known HTML elements to mark up advanced semantic features](/content/Learn/HTML/Introduction_to_HTML/Advanced_text_formatting).
...
- Turn the second paragraph into a block-level quote, and semantically indicate that the quote is taken from [Accessibility](/content/Learn/Accessibility).
