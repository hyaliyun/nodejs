...
Before starting this module, you don't need any previous HTML knowledge, but you should have at least basic familiarity with using computers and using the web passively (i.e., just looking at it and consuming content). You should have a basic work environment set up (as detailed in [Installing basic software](/content/Learn/Getting_started_with_the_web/Installing_basic_software)), and understand how to create and manage files (as detailed in [Dealing with files](/content/Learn/Getting_started_with_the_web/Dealing_with_files)). Both are parts of our [Getting started with the web](/content/Learn/Getting_started_with_the_web) complete beginner's module.
...
- [Getting started with HTML](/content/Learn/HTML/Introduction_to_HTML/Getting_started)
  - : Covers the absolute basics of HTML, to get you started — we define elements, attributes, and other important terms, and show where they fit in the language. We also show how a typical HTML page is structured and how an HTML element is structured, and explain other important basic language features. Along the way, we'll play with some HTML to get you interested!
- [What's in the head? Metadata in HTML](/content/Learn/HTML/Introduction_to_HTML/The_head_metadata_in_HTML)
...
- [HTML text fundamentals](/content/Learn/HTML/Introduction_to_HTML/HTML_text_fundamentals)
...
- [Creating hyperlinks](/content/Learn/HTML/Introduction_to_HTML/Creating_hyperlinks)
...
- [Advanced text formatting](/content/Learn/HTML/Introduction_to_HTML/Advanced_text_formatting)
  - : There are many other elements in HTML for formatting text that we didn't get to in the [HTML text fundamentals](/content/Learn/HTML/Introduction_to_HTML/HTML_text_fundamentals) article. The elements here are less well-known, but still useful to know about. In this article, you'll learn about marking up quotations, description lists, computer code and other related text, subscript and superscript, contact information, and more.
- [Document and website structure](/content/Learn/HTML/Introduction_to_HTML/Document_and_website_structure)
...
- [Debugging HTML](/content/Learn/HTML/Introduction_to_HTML/Debugging_HTML)
...
- [Marking up a letter](/content/Learn/HTML/Introduction_to_HTML/Marking_up_a_letter)
...
- [Structuring a page of content](/content/Learn/HTML/Introduction_to_HTML/Structuring_a_page_of_content)
