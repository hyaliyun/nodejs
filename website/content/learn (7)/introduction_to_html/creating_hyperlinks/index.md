...
A basic link is created by wrapping the text or other content inside an {{htmlelement("a")}} element and using the [`href`](/content/Web/HTML/Element/a#href) attribute, also known as a **Hypertext Reference**, or **target**, that contains the web address.
...
To do this you first have to assign an [`id`](/content/Web/HTML/Global_attributes#id) attribute to the element you want to link to.
...
In fact, the email address is optional. If you omit it and your [`href`](/content/Web/HTML/Element/a#href) is "mailto:", a new outgoing email window will be opened by the user's email client with no destination address.
...
> Read [The GET method](/content/Learn/Forms/Sending_and_retrieving_form_data#the_get_method) to understand what URL query notation is more commonly used for.
...
You've reached the end of this article, but can you remember the most important information? You can find some further tests to verify that you've retained this information before you move on — see [Test your skills: Links](/content/Learn/HTML/Introduction_to_HTML/Test_your_skills:_Links).

## Summary

That's it for links, for now anyway! You'll return to links later on in the course when you start to look at styling them. Next up for HTML, we'll return to text semantics and look at some more advanced/unusual features that you'll find useful — [Advanced text formatting](/content/Learn/HTML/Introduction_to_HTML/Advanced_text_formatting) is your next stop.
