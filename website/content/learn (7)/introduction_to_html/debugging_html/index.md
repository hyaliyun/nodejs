    ...
    <tr>
      ...
      <td>
        HTML familiarity, as covered in, for example, <a
          href="/content/Learn/HTML/Introduction_to_HTML/Getting_started"
...
4. Let's review the problems:
   ...
   - The [`href`](/content/Web/HTML/Element/a#href) attribute value is missing a closing double quote. This seems to have caused the biggest problem — the link has not rendered at all.

5. Now let's look at the markup the browser has rendered, as opposed to the markup in the source code. To do this, we can use the browser developer tools. If you are not familiar with how to use your browser's developer tools, take a few minutes to review [Discover browser developer tools](/content/Learn/Common_questions/Tools_and_setup/What_are_browser_developer_tools).
