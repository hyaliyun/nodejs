...
Now that we are done with attribute selectors, you can continue on to the next article and read about [pseudo-class and pseudo-element selectors](/content/Learn/CSS/Building_blocks/Selectors/Pseudo-classes_and_pseudo-elements).
