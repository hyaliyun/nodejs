...
The three possible values for the [`writing-mode`](/content/Web/CSS/writing-mode) property are:
...
We have already discussed [block and inline layout](/content/Web/CSS/CSS_flow_layout/Block_and_inline_layout_in_normal_flow), and the fact that some things display as block elements and others as inline elements. As we have seen described above, block and inline is tied to the writing mode of the document, and not the physical screen. Blocks are only displayed from the top to the bottom of the page if you are using a writing mode that displays text horizontally, such as English.
...
There are a huge number of properties when you consider all of the individual border longhands, and you can see all of the mapped properties on the MDN page for [Logical Properties and Values](/content/Web/CSS/CSS_logical_properties_and_values).
...
You've reached the end of this article, but can you remember the most important information? You can find some further tests to verify that you've retained this information before you move on — see [Test your skills: Writing modes and logical properties](/content/Learn/CSS/Building_blocks/Writing_Modes_Tasks).
...
In the next article, we'll take a good look at [overflow](/content/Learn/CSS/Building_blocks/Overflowing_content) in CSS.
