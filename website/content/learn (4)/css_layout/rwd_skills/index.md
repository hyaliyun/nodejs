...
The aim of this skill test is to assess whether you understand [how to use media queries](/content/Learn/CSS/CSS_layout/Media_queries) and get you working with responsive web design with a practical task. Everything you need to know to complete this task is covered in the layout lessons in the [CSS layout module](/content/Learn/CSS/CSS_layout).
