...
The aim of this skill test is to assess whether you understand how a [grid and grid items](/content/Learn/CSS/CSS_layout/Grids) behave. You will be working through several small tasks that use different elements of the material you have just covered.
