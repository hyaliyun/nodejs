...
1. Have basic familiarity with HTML, as discussed in the [Introduction to HTML](/content/Learn/HTML/Introduction_to_HTML) module.
2. Be comfortable with CSS fundamentals, as discussed in [Introduction to CSS](/content/Learn/CSS/First_steps).
3. Understand how to [style boxes](/content/Learn/CSS/Building_blocks).
...
- [Introduction to CSS layout](/content/Learn/CSS/CSS_layout/Introduction)
...
- [Normal flow](/content/Learn/CSS/CSS_layout/Normal_Flow)
...
- [Flexbox](/content/Learn/CSS/CSS_layout/Flexbox)
  - : [Flexbox](/content/Web/CSS/CSS_flexible_box_layout/Typical_use_cases_of_flexbox) is a one-dimensional layout method for laying out items in rows or columns. Items flex to fill additional space and shrink to fit into smaller spaces. This article explains all the fundamentals. After studying this guide you can [test your flexbox skills](/content/Learn/CSS/CSS_layout/Flexbox_skills) to check your understanding before moving on.
- [Grids](/content/Learn/CSS/CSS_layout/Grids)
  - : CSS grid layout is a two-dimensional layout system for the web. It lets you lay content out in rows and columns, and has many features that make building complex layouts straightforward. This article will give you all you need to know to get started with page layout, then [test your grid skills](/content/Learn/CSS/CSS_layout/Grid_skills) before moving on.
- [Floats](/content/Learn/CSS/CSS_layout/Floats)
...
- [Positioning](/content/Learn/CSS/CSS_layout/Positioning)
...
- [Multiple-column layout](/content/Learn/CSS/CSS_layout/Multiple-column_Layout)
...
- [Responsive design](/content/Learn/CSS/CSS_layout/Responsive_Design)
...
- [Beginner's guide to media queries](/content/Learn/CSS/CSS_layout/Media_queries)
...
- [Legacy layout methods](/content/Learn/CSS/CSS_layout/Legacy_Layout_Methods)
...
- [Supporting older browsers](/content/Learn/CSS/CSS_layout/Supporting_Older_Browsers)
...
- [Fundamental layout comprehension](/content/Learn/CSS/CSS_layout/Fundamental_Layout_Comprehension)
  - : An assessment to test your knowledge of different layout methods by laying out a webpage.

## See also

- [Practical positioning examples](/content/Learn/CSS/CSS_layout/Practical_positioning_examples)
  - : This article shows how to build some real-world examples to illustrate what kinds of things you can do with positioning.
- [CSS layout cookbook](/content/Web/CSS/Layout_cookbook)
