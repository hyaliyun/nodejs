...
- [2D breakout game using pure JavaScript](/Games/Tutorials/2D_Breakout_game_pure_JavaScript)
...
- [2D breakout game using Phaser](/Games/Tutorials/2D_breakout_game_Phaser)
...
- [2D maze game with device orientation](/Games/Tutorials/HTML5_Gamedev_Phaser_Device_Orientation)
  - : This tutorial shows how to create a 2D maze game using HTML, incorporating fundamentals such as collision detection and sprite placement on a {{htmlelement("canvas")}}. This is a mobile game that uses the [Device Orientation](/Web/API/Device_orientation_events) and [Vibration](/Web/API/Vibration_API) **APIs** to enhance the gameplay and is built using the [Phaser](https://phaser.io/) framework.
